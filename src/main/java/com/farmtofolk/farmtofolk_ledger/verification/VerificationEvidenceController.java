...
public class VerificationEvidenceController {
  ...
  public VerificationEvidenceResponse uploadVerificationEvidence(
    ...
    return verificationEvidenceService.uploadVerificationEvidence(
        verificationId, file, caption, isPublic);
  }

  @GetMapping("/api/verifications/{verificationId}/evidence")
  public List<VerificationEvidenceResponse> getEvidenceForVerification(
      @PathVariable UUID verificationId) {
