...
public class BatchProcurement {
    ...
    private void normalizeDefaultsAndCalculate() {
        ...
        paymentStatus = paymentStatus == null ? null : paymentStatus.trim().toUpperCase(Locale.ROOT);
    ...
    public BigDecimal getQuantityTaken() { return quantityTaken; }
    public void setQuantityTaken(BigDecimal quantityTaken) { this.quantityTaken = quantityTaken; }
    public BigDecimal getFarmerPricePerUnit() { return farmerPricePerUnit; }
    public void setFarmerPricePerUnit(BigDecimal farmerPricePerUnit) { this.farmerPricePerUnit = farmerPricePerUnit; }
    public BigDecimal getFarmerAmountPayable() { return farmerAmountPayable; }
    public void calculateFarmerAmountPayable() { this.farmerAmountPayable = quantityTaken.multiply(farmerPricePerUnit); }
    public String getPaymentStatus() { return paymentStatus; }
    public void setPaymentStatus(String paymentStatus) {
        this.paymentStatus = paymentStatus == null ? null : paymentStatus.trim().toUpperCase(Locale.ROOT);
    }
    public String getCurrency() { return currency; }
    public void setCurrency(String currency) {
        this.currency = currency == null || currency.isBlank() ? "INR" : currency.trim().toUpperCase(Locale.ROOT);
    }
    public LocalDateTime getProcuredAt() { return procuredAt; }
    public void setProcuredAt(LocalDateTime procuredAt) { this.procuredAt = procuredAt; }
