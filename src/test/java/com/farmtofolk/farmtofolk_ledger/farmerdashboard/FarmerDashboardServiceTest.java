...
class FarmerDashboardServiceTest {
    ...
    private FarmerDashboardService service() {
        return new FarmerDashboardService(
                currentUserService, userRepository, farmerRepository, farmRepository, batchRepository,
                traceEventRepository, priceBreakdownRepository, procurementRepository, saleTransactionRepository
        );
    }
