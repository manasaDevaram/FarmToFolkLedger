...
class UserAdminServiceTest {
    ...
    void farmerUserIsHashedAndLinkedToFarmerProfile() {
        ...
        UserAdminService service = new UserAdminService(userRepository, farmerRepository, passwordEncoder);

        service.createUser(new CreateUserRequest(
                "Ramesh", "ramesh@example.com", "9876543210", "password123",
                "FARMER", "MALE", "Mysuru", farmerId
        ));
